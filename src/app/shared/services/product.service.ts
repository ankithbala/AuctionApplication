...
export class ProductService {
	...
	createProduct(data: Product) {
		...
		this.myProducts.push(data.productDescription);
  ...
  */
	...
	addToCart(data: Product): void {
		...
		this.myProduct={
			"id":14,
			"price": a[14]["productPrice"],
			"name":a[14]["productName"]
		  
		  
		  }

		  console.log(a[14]["productName"]);
		
			let obs= this.http.post("http://localhost/productPost",this.myProduct);
